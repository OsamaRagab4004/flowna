...
// --- Main Component ---
const DefinitionsList = ({ definitions }: { definitions: Concept[] }) => {
    const [openItem, setOpenItem] = useState<string | null>(null);

    // Debug logging
    console.log('🔍 [DEFINITIONS_LIST] Received definitions:', definitions);
    console.log('🔍 [DEFINITIONS_LIST] Definitions count:', definitions?.length || 0);
